import { GeneratePaginationResponseInterface } from './interfaces/generate-pagination-response.interface';
import { SortDirection } from './interfaces/meta.interface';
 ...
 * @param page - Número da página a será retornada.
 ...
 * @returns Um objeto com as informa es de paginação e dados paginados.
 */
